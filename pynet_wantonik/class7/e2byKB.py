...
def show_current_vlan_config(arista_conn):
    ...
    print 'Dispaly keys: ', show_vlan.keys(),   # tell me how many keys is in this dictionary
    #pprint(show_vlan)
    print 40 * 'X', '\n', '\n'
    return show_vlan
        ...
        if int(vlan) == vlan_id:
            ...
            if raw_input() == 'y':
                try:
                    ...
                    #time.sleep(4)  no improvement when added time sleep here
